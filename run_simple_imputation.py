...
if __name__ == "__main__":
   ...
   #============ Variationnal ===============
    ...
    for dataset in list_dataset:
        folder = os.path.join(path_save,os.path.join("Linear variationnal", type(dataset).__name__))
        for lr in lr_list :
                ...
                for lambda_reg_var in lambda_reg_list :
                    for imputation in imputationMethod_list :
                        ...
                        destruction_var = DestructionModule(destructor_no_var,
                            destructor_var = destructor_var,
                            regularization=free_regularization,
                            regularization_var = free_regularization
                        )
                        ...
                        for epoch in range(nb_epoch):
                            ...
                            dic_train = trainer_var.train(
                                ...
                                Bernoulli, partial(RelaxedBernoulli,temperature),
                            ...
                            dic_test_var = trainer_var.test_var(dataset, Bernoulli, partial(RelaxedBernoulli, temperature))
                            temperature *= 0.5
                        ...
                        sample_list = trainer_var.MCMC_var(dataset,data, target, Bernoulli, partial(RelaxedBernoulli, temperature),5000)
                        save_interpretation(final_path,sample_list, data, target, suffix = "var")
