...
if __name__ == '__main__' :
    ...
    for method in ["relax", "reinforce", "reinforce_baseline", "allz"]:
        ...
        if method == "allz":
            get_all_z_baseline(args_complete_trainer, args_classification, args_train)
        ...
        for cste in [0, -1, 10]:
            for lambda_reg in [0, 0.1, 1.0, 10]:
                for mask in [True, False]:
                    ...
                    args_output["experiment_name"] = method + "_cste_" + str(cste) + "_lambda_reg_" + str(lambda_reg) + "mask"+ str(mask)
