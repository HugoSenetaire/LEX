...
if __name__ == '__main__' :
    ...
    for cste in [0]:
        for lambda_reg in [0, 0.1, 1.0]:
            for name, post_process_regularization in [ ("VAEAC_IMPUTATION_DETACH",VAEAC_Imputation_DetachVersion), ("MICE_imputation_pretrained", MICE_imputation_pretrained),
                                                        ("Vanilla", None), ("DATASETBASED", DatasetBasedImputation)]:
                ...
                args_output["experiment_name"] ="default_trainer_" + name +"_cste_"+str(cste)+"_lambda_reg" + str(lambda_reg)
