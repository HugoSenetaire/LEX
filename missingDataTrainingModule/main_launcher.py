...
def experiment(dataset, loader, complete_args):
    ...
    complete_args = convert_all(complete_args)

    print(vars(complete_args.args_classification))
    print("====================================================================================================================================================")
    ...
    if complete_args.args_train.post_hoc and complete_args.args_train.post_hoc_guidance is not None :
        ...
        optim_post_hoc, scheduler_post_hoc = get_optim(post_hoc_guidance, 
                                                    complete_args.args_compiler.optim_post_hoc,
                                                    complete_args.args_compiler.optim_post_hoc_param,
                                                    complete_args.args_compiler.scheduler_post_hoc,
                                                    complete_args.args_compiler.scheduler_post_hoc_param,)
    ...
    if (complete_args.args_trainer.complete_trainer is EVAL_X) or (complete_args.args_trainer.complete_trainer is REALX) :
            ...
            optim_classification, scheduler_classification = get_optim(classification_module,
                                                            complete_args.args_compiler.optim_classification,
                                                            complete_args.args_compiler.optim_classification_param,
                                                            complete_args.args_compiler.scheduler_classification,
                                                            complete_args.args_compiler.scheduler_classification_param,)
    ...
    if complete_args.args_train.nb_epoch_pretrain_selector > 0 :
        ...
        optim_selection, scheduler_selection = get_optim(selection_module,
                                            complete_args.args_compiler.optim_selection,
                                            complete_args.args_compiler.optim_selection_param,
                                            complete_args.args_compiler.scheduler_selection,
                                            complete_args.args_compiler.scheduler_selection_param,)
    ...
    optim_baseline, scheduler_baseline = get_optim(baseline,
                                        complete_args.args_compiler.optim_baseline,
                                        complete_args.args_compiler.optim_baseline_param,
                                        complete_args.args_compiler.scheduler_baseline,
                                        complete_args.args_compiler.scheduler_baseline_param,)
    optim_distribution_module, scheduler_distribution_module = get_optim(distribution_module,
                                                                complete_args.args_compiler.optim_distribution_module,
                                                                complete_args.args_compiler.optim_distribution_module_param,
                                                                complete_args.args_compiler.scheduler_distribution_module,
                                                                complete_args.args_compiler.scheduler_distribution_module_param,)
