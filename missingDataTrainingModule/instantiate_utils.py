...
def get_imputation_method(args_classification, dataset,):
    ...
    module_imputation = instantiate_module_imputation(args_classification.module_imputation, args_classification.module_imputation_parameters)
...
def get_networks(args_classification, args_selection, args_trainer, args_interpretable_module, args_dataset, dataset = None):
    

    dim_output = args_dataset.dataset_output_dim
    input_size_classifier = args_classification.input_size_prediction_module
    if args_classification.add_mask :
        init_shape = args_dataset.dataset_input_dim
