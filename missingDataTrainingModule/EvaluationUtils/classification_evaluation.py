    ...
    with torch.no_grad():
        for batch_index, data in enumerate(loader.test_loader):
            ...
            if trainer is not None :
                target, one_hot_target = define_target(data,
                                                        index,
                                                        target,
...
def multiple_test(interpretable_module, loader, nb_sample_z_monte_carlo = 1, nb_sample_z_iwae = 1, mask_sampling = None, set_manual_seed = None, trainer = None, prefix = ""):
        """
